...
class PlanOutput(BaseModel):
    ...
    entry_points: List[str] = Field(
        description="Paths to main application starts"
    )
...
class SolcraftState(BaseFlowModel):
    ...
    task_templates: Optional[List[str]] = Field(
        default=None, description="Paths to task template markdown files"
    )
...
class TaskTemplate(BaseModel):
    ...
    context: Optional[List[str]] = Field(
        default=None, description="List of task names this depends on"
    )
